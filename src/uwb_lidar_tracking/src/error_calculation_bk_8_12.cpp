...
std::string target_amcl_file_name("/home/gglin/WORKSPACE/uwb_lidar_following_gglin/dataset/record/target_amcl.txt");
std::string robot_amcl_file_name("/home/gglin/WORKSPACE/uwb_lidar_following_gglin/dataset/record/robot_amcl.txt");
std::string target_est_file_name("/home/gglin/WORKSPACE/uwb_lidar_following_gglin/dataset/record/target_est.txt");
